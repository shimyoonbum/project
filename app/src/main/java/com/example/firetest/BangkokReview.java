...
public class BangkokReview extends AppCompatActivity implements View.OnClickListener {
    ...
    private void upload(String uri){
        ...
        StorageReference riversRef = storageRef.child("bangkok/"+file.getLastPathSegment());
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                database.getReference().child("bangkok").push().setValue(f);
            }
        });
    }
}

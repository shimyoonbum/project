...
public class Sevilla extends TabActivity {
    public final static String VIDEO_URL = "https://www.youtube.com/watch?v=qJaTRl4b6vE";
    public final static String VIDEO_URL2 = "https://www.youtube.com/watch?v=0OmSPQ0tL4A";
    public final static String VIDEO_URL3 = "https://www.youtube.com/watch?v=u6iCa1pvGlQ";
    public final static String VIDEO_URL4 = "https://www.youtube.com/watch?v=FUMFB9-lk74";

    GallerySevillaAdapter adapter5;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter5 = new GallerySevillaAdapter(this);

        for (int i = 1; i < 5; i++) {
            adapter5.addItem(getResources().getIdentifier("s" + i, "drawable", this.getPackageName()));
        }
        ...
        web.loadUrl("https://weather.com/ko-KR/weather/hourbyhour/l/9a2cd0f1a58bba9b0faeff21c6d1f3eab2fc6ce53221d66643c33afed7d6e30f");

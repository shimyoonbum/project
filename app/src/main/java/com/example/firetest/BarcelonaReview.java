...
public class BarcelonaReview extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_insert:
                ...
                break;
            case R.id.btn2:
                Intent i = new Intent(this, BoardActivity6.class);
                startActivity(i);
        }
    }
    @Override
    ...
    private void upload(String uri){
        ...
        StorageReference riversRef = storageRef.child("barcelona/"+file.getLastPathSegment());
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                database.getReference().child("barcelona").push().setValue(f);
            }
        });
    }
}

...
public class Hanoi extends TabActivity {

    public final static String VIDEO_URL = "https://www.youtube.com/watch?v=o0TR6eOm22I";
    public final static String VIDEO_URL2 = "https://www.youtube.com/watch?v=POR8htKM1MQ";
    public final static String VIDEO_URL3 = "https://www.youtube.com/watch?v=MRwO4hIBt90";
    public final static String VIDEO_URL4 = "https://www.youtube.com/watch?v=gSqMDrdRBRE";
    public final static String VIDEO_URL5 = "https://www.youtube.com/watch?v=pbIuyCdyc70";
    GalleryHanoiAdapter adapter3;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter3 = new GalleryHanoiAdapter(this);

        for(int i = 1; i < 6; i++){
            adapter3.addItem(getResources().getIdentifier("hanoi"+i, "drawable",this.getPackageName()));
        }
        ...
        gallery.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            public void onItemClick(AdapterView<?> parent, View v, int position, long id){
                Integer galleryItem = adapter3.getGalleryItem(position);
        ...
        web.loadUrl("https://weather.com/ko-KR/weather/hourbyhour/l/65bbbcbef8448c1f971408c74ed922af1bed94ddd8cc7a48d2bae40e75cef726");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getBaseContext(), HanoiReview.class);
                startActivity(i);
            }
        });

...
public class PattayaReview extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_insert:
                ...
                break;
            case R.id.btn2:
                Intent i = new Intent(this, BoardActivity9.class);
                startActivity(i);
        }
    }
    @Override
    ...
    private void upload(String uri){
        ...
        StorageReference riversRef = storageRef.child("pattaya/"+file.getLastPathSegment());
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                database.getReference().child("pattaya").push().setValue(f);
            }
        });
    }
}

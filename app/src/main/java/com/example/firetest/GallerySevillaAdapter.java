...
public class GallerySevillaAdapter extends BaseAdapter {
    ...
    public GallerySevillaAdapter(Context mContext){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        galleryList2.add("스페인 광장");
        galleryList2.add("세비야 대성당");
        galleryList2.add("히랄다");
        galleryList2.add("황금의 탑");

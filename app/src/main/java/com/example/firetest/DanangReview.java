...
public class DanangReview extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_insert:
                ...
                break;
            case R.id.btn2:
                Intent i = new Intent(this, BoardActivity3.class);
                startActivity(i);
        }
    }
    @Override
    ...
    private void upload(String uri){
        ...
        StorageReference riversRef = storageRef.child("danang/"+file.getLastPathSegment());
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                database.getReference().child("danang").push().setValue(f);
            }
        });
    }
}

...
public class GalleryChiangAdapter extends BaseAdapter {
    ...
    public GalleryChiangAdapter(Context mContext){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        galleryList2.add("와로롯 시장");
        galleryList2.add("왓 치앙만");
        galleryList2.add("마야 몰");
        galleryList2.add("나이트 바자 야시장");
        galleryList2.add("백색 사원");

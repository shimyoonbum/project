...
public class SevillaReview extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_insert:
                ...
                break;
            case R.id.btn2:
                Intent i = new Intent(this, BoardActivity8.class);
                startActivity(i);
        }
    }
    @Override
    ...
    private void upload(String uri){
        ...
        StorageReference riversRef = storageRef.child("sevilla/"+file.getLastPathSegment());
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                database.getReference().child("sevilla").push().setValue(f);
            }
        });
    }
}
